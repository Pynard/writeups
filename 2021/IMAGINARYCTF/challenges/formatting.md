...
Attachments
https://imaginaryctf.org/r/14BD-stonks.py nc chal.imaginaryctf.org 42014
```

- Fichier : [stonks.py](../attachements/formatting/stonks.py)
```python
#!/usr/bin/env python3
...
Here we have to abuse **format** function to leak the **flag** variable.

We will use this [format string vulnerability](https://python-forum.io/thread-11421.html)
...
```
$ ncat chal.imaginaryctf.org 42014
